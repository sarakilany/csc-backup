...
const About = () => {
    ...
    const icons = [<Person color="#0b6e4f" size={40} />, <Intersect color="#0b6e4f" size={40} />, <People color="#0b6e4f" size={40} />, <Cone color="#0b6e4f" size={40} />, <Tree color="#0b6e4f" size={40} />, <Tree color="#0b6e4f" size={40} />];
    ...
    return (
        <>
            ...
            <Container className='py-5'>
                ...
                <Row className='mb-5'>
                    <Col style={{ backgroundColor: '#0b6e4f', marginLeft: '1rem' }}>
                ...
                <Row xs={1} md={3} className="g-4">
                    {Array.from({ length: 6 }).map((_, idx) => (
                        <Col >
                            <Card className="px-5 py-4" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
